# TS2591 Lux Sensor with Particle Argon
This the sensor we are going to build in this exercise.

```{figure} /_static/0213task13/img1.jpg
:width: 50%
```
...
- USB Data Cable
- TS2591 (Can be bought <a href="https://www.adafruit.com/product/1980" target="_blank">here</a>)
...
1. Connect the Argon and TS2591 Sensor onto the breadboard as shown in the figures.
    </Br><Br/>
...
3. Flash the script **'STAPI_1_TS2591'** to the Argon. Fill in the mandatory parameters accordingly. You can choose to leave the optional parameters to their default values.
    ```
    =============================================================================================
    !!! MANDATORY PARAMETERS
    =============================================================================================
    String thingDesc = "ts2591"; //DESCRIBE THE DEPLOYMENT
